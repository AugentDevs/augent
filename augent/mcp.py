...
def _get_style_instruction(
    ...
    styles = {
        "tldr": (
            ...
            "- Do NOT include source URL, duration, or date — frontmatter handles metadata\n"
            "- ---\n"
